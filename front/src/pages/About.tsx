...
//   return (
//     <motion.div
//       className="min-h-[80vh] max-w-6xl mx-auto px-6 py-10 bg-pink-100/60 backdrop-blur-lg rounded-3xl shadow-2xl border border-pink-200"
//       initial={{ opacity: 0, y: 50 }}
//       animate={{ opacity: 1, y: 0 }}
//       transition={{ duration: 0.7 }}
//     >
//       <h2 className="text-5xl font-extrabold text-center text-pink-700 mb-6 drop-shadow-xl ">
//         אודות האתר
//       </h2>

//       <p className="text-xl text-center text-purple-800 font-medium mb-10 leading-relaxed max-w-3xl mx-auto">
//         האתר שלנו מוקדש להשראה לעיצוב חדרי ילדים באווירה קסומה וחלומית, עם דגש על רוך, פסטליות, ותחושת בית עוטפת ונעימה.
//       </p>
...
//       <div className="bg-white/90 rounded-2xl p-6 shadow-inner border border-purple-100">
//         <Outlet />
//       </div>
//     </motion.div>
//   );
