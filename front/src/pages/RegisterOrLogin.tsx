...
//         navigate("/"); // ✅ העברה אוטומטית לדף הבית
//       } else {
...
//         navigate("/"); // ✅ העברה אוטומטית גם אחרי הרשמה
//       } else {
...
//         >
//           <h2 className="text-center text-2xl font-semibold mb-4">התחברות</h2>
//           <input
//             value={userName}
...
//           className={`bg-white p-6 rounded-lg shadow-lg w-full max-w-md ${!isLogin ? "" : "hidden"}`}
//         >
//           <h2 className="text-center text-2xl font-semibold mb-4">הרשמה</h2>
//           <input
//             value={userName}
//             onChange={(e) => setUserName(e.target.value)}
//             placeholder="שם משתמש"
...
//   const handleAuth = async (e: React.FormEvent) => {
//     e.preventDefault();
//     console.log("📥 handleAuth התחיל – isLogin:", isLogin);
...
//           onClick={() => {
//             setIsLogin(!isLogin);
//             console.log("🔄 החלפת מצב – עכשיו isLogin:", !isLogin);
//           }}
//           className="text-blue-500 hover:text-blue-700 text-lg font-semibold"
//         >
//           {isLogin ? "הרשמה" : "התחברות"}
